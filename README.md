![Alt Text](https://github.com/caglaryalcin/after-format/blob/main/files/flux.gif)
...
- Installing 7-zip, Mozilla Firefox, Google Chrome, PuTTY, iTunes, Notepad++, VMWARE Workstation Pro, Filezilla, Deluge, HWMonitor, Cryptomator, LibreOffice, Wireshark, VirtualBox, Steam, Signal Desktop, Rufus, K-Lite Codec Pack Mega, TreeSize, Speedtest, Windows Terminal, Visual Studio Code, Libre Wolf, VLC Player.
</details>
