...
#Install Asus Maximus x hero drivers
Function Drivers {
...
#Disabling exclude VG278 and Headseat external inputs
Function Sound {
    Write-Host "Adjusting my sound settings..." -NoNewline
    reg import "C:\after-format-main\files\sound.reg" *>$null
    Write-Host "[DONE]" -ForegroundColor Green -BackgroundColor Black
}
